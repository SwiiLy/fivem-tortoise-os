...
export class VehicleComponent extends HTMLElement {
    ...
    static get observedAttributes() { return ["display","rpm","speed","gear","fuel", "crash", "color"];}
        ...
        if (newValue != oldValue) {
            switch(name) {
                ...
                case "gear":
                    ...
                    break;
                case "color":
                    this.shadowRoot!.querySelector<HTMLElement>('[id="gaugerpm"]')!.className = newValue
                    this.shadowRoot!.querySelector<HTMLElement>('[id="gaugespeed"]')!.className = newValue
                    this.shadowRoot!.querySelector<HTMLElement>('[id="fuel-value"]')!.className = newValue
